  ...
  const { mutate, isPending } = useMutation({
    mutationFn: async (data: ContactFormValues) => {
      try {
        ...
        // If API request fails (as it will on GitHub Pages), handle gracefully
        console.log("API request failed, would normally send:", data);
        // For GitHub Pages deployment where no backend is available
        // We're simulating a successful submission
        return { success: true, message: "Form data received (simulation for static hosting)" };
      }
    },
    onSuccess: () => {
      toast({
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div>
            <p className="text-lg mb-8">
              ...
              or learn more about our services with Dr. Tracy Lee Kalebs.
            </p>
            ...
            <div className="mt-8 p-6 bg-[#F5F5F5] rounded-lg">
              <h3 className="font-medium text-lg mb-2">A Note from Dr. Kalebs</h3>
              <p className="italic">
                "Taking the first step toward healing can be the most challenging part of the journey. I'm here to support you with compassion, expertise, and a collaborative approach tailored to your unique needs. I look forward to connecting with you."
              </p>
            </div>
          </div>
